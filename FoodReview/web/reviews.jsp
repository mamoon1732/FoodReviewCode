...
<html>
    ...
    <body style="text-align: center">
        ...
        while (rs.next()){
            %><strong><%out.println(rs.getString("mealName"));%></strong><br><%
            %><strong><%out.println(rs.getString("reviewName"));%></strong><br><%
            %><strong><%out.println(rs.getInt("reviewScore"));%></strong><br><%
            %><strong><%out.println(rs.getString("review"));%></strong><br><%
            %><hr><%
        }
